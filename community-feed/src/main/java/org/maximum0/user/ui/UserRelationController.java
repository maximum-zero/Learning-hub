...
public class UserRelationController {
    ...
    @PostMapping("/follow")
    public Response<Void> followUser(@RequestBody FollowUserRequestDto requestDto) {
    ...
    public Response<Void> unfollowUser(@RequestBody FollowUserRequestDto requestDto) {
